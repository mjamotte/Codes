To be able to use this code, the user should write in the following files, the correct "paths" to the folders where the datas should extracted from, in order to plot the results of the codes: 
